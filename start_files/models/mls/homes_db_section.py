...
class Mls_homes(Base):
    ...
    listing_office =  Column(String(100), index=True)
    listing_office_number = Column(String(20), index=True)
    listing_agent = Column(String(20), index=True)
    listing_agent_number = Column(String(20), index=True)
    listing_agent_email = Column(String(20), index=True)
    ...
    if original_listings:
        temp_listings = [
            Mls_homes_temp(
                ...
                fee=item.fee,
                freq=item.freq,
                listing_office=item.listing_office,
                listing_office_number=item.listing_office_number,
                listing_agent=item.listing_agent,
                listing_agent_number=item.listing_agent_number,
...
def process_row(row):
    ...
    return {
        ...
        "LISTING_OFFICE_NUMBER": row['listing_office_number'],
        "LISTING_AGENT": row['listing_agent'],
        "LISTING_AGENT_NUMBER": row['listing_agent_number'],
